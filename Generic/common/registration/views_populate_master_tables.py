...
def populate_source_status(table_population_output_list):
    ...
    try:
        ...
        final_model_data = [
            {'status_id': 1, 'status_name': "Active", 'added_by': "genericbackend", 'last_modified_by': "genericbackend", 'history': "source Active"},
            {'status_id': 2, 'status_name': "Inactive", 'added_by': "genericbackend", 'last_modified_by': "genericbackend", 'history': "source Inactive"},
        ]
...
def populate_Sources(table_population_output_list):
    ...
    try:
        ...
        final_model_data = [
            {'source_id': 1, 'source_name': "Native Email", 'added_by': "genericbackend", 'last_modified_by': "genericbackend",
             'history': "email updated", 'source_keys': "esdfghytgfvcxdzfsgtrfc", 'source_status': 1},

            {'source_id': 2, 'source_name': "Native Mobile", 'added_by': "genericbackend", 'last_modified_by': "genericbackend",
             'history': "mobile updated", 'source_keys': "drgtyrtgfdghyjuio7iuygf", 'source_status': 1},

            {'source_id': 3, 'source_name': "facebook", 'added_by': "genericbackend", 'last_modified_by': "genericbackend",
             'history': "facebook updated", 'source_keys': "drgthgfdsfrtyjytr", 'source_status': 1},

            {'source_id': 4, 'source_name': "Google", 'added_by': "genericbackend", 'last_modified_by': "genericbackend",
             'history': "google updated", 'source_keys': "qwertyuhgfgfrthryjt", 'source_status': 1},

            {'source_id': 5, 'source_name': "Twitter", 'added_by': "genericbackend", 'last_modified_by': "genericbackend",
             'history': "twitter updated", 'source_keys': "wertyghfhytui8uyhgfds", 'source_status': 1},

            {'source_id': 6, 'source_name': "Linkedin", 'added_by': "genericbackend", 'last_modified_by': "genericbackend",
...
def populate_email_verification_Status(table_population_output_list):
    ...
    try:
        ...
        final_model_data = [
            {'status_id': 1, 'status_name': "Pending", 'added_by': "genericbackend", 'last_modified_by': "genericbackend",
             'history': "added by admin: genericbackend"},

            {'status_id': 2, 'status_name': "Active", 'added_by': "genericbackend", 'last_modified_by': "genericbackend",
             'history': "added by admin: genericbackend"},

            {'status_id': 3, 'status_name': "Inactive", 'added_by': "genericbackend", 'last_modified_by': "genericbackend",
             'history': "added by admin: genericbackend"},

            {'status_id': 4, 'status_name': "Blocked", 'added_by': "genericbackend", 'last_modified_by': "genericbackend",
             'history': "added by admin: genericbackend"},

            {'status_id': 5, 'status_name': "Work In Progress", 'added_by': "genericbackend", 'last_modified_by': "genericbackend",
             'history': "added by admin: genericbackend"},

            {'status_id': 6, 'status_name': "Deactivated", 'added_by': "genericbackend", 'last_modified_by': "genericbackend",
             'history': "added by admin: genericbackend"},

            {'status_id': 7, 'status_name': "Not All Parameter Passed", 'added_by': "genericbackend", 'last_modified_by': "genericbackend",
             'history': "added by admin: genericbackend"},
        ]
...
def populate_mobile_verification_status(table_population_output_list):
    ...
    try:
        ...
        final_model_data = [
            {'status_id': 1, 'status_name': "Active", 'added_by': "genericbackend", 'last_modified_by': "genericbackend",},
            {'status_id': 2, 'status_name': "Inactive", 'added_by': "genericbackend", 'last_modified_by': "genericbackend"},
        ]
...
def populate_user_profile_completion_status(table_population_output_list):
    ...
    try:
        ...
        final_model_data = [
            {'status_id': 1, 'status_name': "Completed", 'added_by': "genericbackend", 'last_modified_by': "genericbackend",},
            {'status_id': 2, 'status_name': "Incompleted", 'added_by': "genericbackend", 'last_modified_by': "genericbackend"},
        ]
...
def populate_dp_flag(table_population_output_list):
    ...
    try:
        ...
        final_model_data = [
            {'flag_id': 1, 'flag_name': "Systemdefined", 'added_by': "genericbackend", 'last_modified_by': "genericbackend",},
            {'flag_id': 2, 'flag_name': "Userdefined", 'added_by': "genericbackend", 'last_modified_by': "genericbackend"},
        ]
