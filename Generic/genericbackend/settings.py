"""
Django settings for genericbackend project.
...
ROOT_URLCONF = 'genericbackend.urls'
...
WSGI_APPLICATION = 'genericbackend.wsgi.application'
...
ASGI_APPLICATION = 'genericbackend.routing.application'
CHANNEL_LAYERS = {
    'default': {
