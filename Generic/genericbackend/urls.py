"""genericbackend URL Configuration
...
from common.location.api.getallcountriesdetails.views_getallcountriesdetails import GetAllCountriesAPI  # genericbackend: Moved from existing to revised
from common.location.api.getallcitiesdetailsbystate.views_getallcitiesdetailsbystate import GetAllCitiesByStateAPI  # genericbackend: Moved from existing to revised
from common.location.api.getallstatesdetailsbycountry.views_getallstatesdetailsbycountry import GetAllStatesByCountryAPI  # genericbackend: Moved from existing to revised
